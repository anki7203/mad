...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <section class="read react">
            <div class="success" style="display:none;"><h2>Your reaction has been recorded!</h2></div>
            <section class="react-form">
                <input type="text" placeholder="Your Name or Alias"/>
                <textarea placeholder="Reaction goes here bud..."></textarea>
